      ...
      <View style={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.optionList}>
            {[
              { value: "30", label: "Đặt cọc 30%", amount: Math.round(totalAmount * 0.3) },
              { value: "50", label: "Đặt cọc 50%", amount: Math.round(totalAmount * 0.5) },
              { value: "100", label: "Thanh toán 100%", amount: totalAmount },
            ].map((option) => (
              <TouchableOpacity
                key={option.value}
        ...
        <View style={styles.orderSummary}>
          ...
          <View style={styles.summaryRow}>
            ...
            <Text style={[styles.summaryValue, { color: "#6b7280" }]}>
              {formatPrice(totalAmount - getPaymentAmount())}
            </Text>
          </View>
        </View>
